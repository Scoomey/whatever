...
class PairingsController < ApplicationController
  ...
  def otp
    ...
    url_2 = "https://api.spoonacular.com/recipes/complexSearch?apiKey=fa11ae9f2b3e49448a8060b40a854d5e&diet=#{params[:otp][:diet]}&minCalories=#{params[:otp][:mincalories]}&maxCalories=#{params[:otp][:maxcalories]}&intolerances=#{params[:otp][:intolerances]}&type=mainCourse&sort=random&number=1"
    url_3 = "https://api.spoonacular.com/recipes/complexSearch?apiKey=fa11ae9f2b3e49448a8060b40a854d5e&diet=#{params[:otp][:diet]}&minCalories=#{params[:otp][:mincalories]}&maxCalories=#{params[:otp][:maxcalories]}&type=mainCourse&sort=random&number=1"
    url_4 = "https://api.spoonacular.com/recipes/complexSearch?apiKey=fa11ae9f2b3e49448a8060b40a854d5e&minCalories=#{params[:otp][:mincalories]}&maxCalories=#{params[:otp][:maxcalories]}&intolerances=#{params[:otp][:intolerances]}&type=mainCourse&sort=random&number=1"
    url_5 = "https://api.spoonacular.com/recipes/complexSearch?apiKey=fa11ae9f2b3e49448a8060b40a854d5e&minCalories=#{params[:otp][:mincalories]}&maxCalories=#{params[:otp][:maxcalories]}&type=mainCourse&sort=random&number=1"
